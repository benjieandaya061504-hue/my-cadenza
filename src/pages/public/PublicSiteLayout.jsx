        ...
        >
          ...
          <div style={{
            ...
            <button
              ...
              onClick={() => {
                if (!signupMode) {
                  setSignupFields({ fname: '', mname: '', lname: '', suffix: '', email: '', phone: '', password: '', confirm: '' })
                  setSignup((s) => ({ ...s, open: true }))
                  loginModal.mode = 'signup'
                  setLoginModal({ ...loginModal, mode: 'signup' })
                }
              }}
            >
              Sign Up
            ...
            <button
              ...
              onClick={() => {
                if (signupMode) {
                  setSignupFields({ fname: '', lname: '', email: '', phone: '', password: '', confirm: '' })
                  setSignup((s) => ({ ...s, open: true }))
                  loginModal.mode = 'login'
                  setLoginModal({ ...loginModal, mode: 'login' })
                }
              }}
            >
              Log In
