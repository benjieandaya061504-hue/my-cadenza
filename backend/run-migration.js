 ...
 * Runs the migration SQL file to add users tables
...
async function runMigration() {
  console.log('')
  console.log('╔════════════════════════════════════════════╗')
  console.log('║     Migration Runner Script               ║')
  console.log('╚════════════════════════════════════════════╝')
  console.log('')

  const migrationPath = path.join(__dirname, 'migrations', 'add_users_tables.sql')
